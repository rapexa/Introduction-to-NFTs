...
ان اف تی ها (NFTs) یا توکن های غیر قابل تعویض ترکیبی از تکنولوژی بلاکچین و دارای های غیر قابل تعویض هستند که قابلیت های منحصر به فرد بودن و قابل اثبات بودن را فراهم کرده اند که با ایجاد بستر مناسب توسط تکنولوژی بلاکچین اثبات موجودیت و اعتبار سنجی دارایی های غیر مثلی دیجیتال را بسیار راحت تر کرده اند.
...
## دارایی های قابل تعویض 
 ...
 اگر چه ممکن است دو نقاشی شبیه به هم به نظر برسند ممکن است سطح نادر بودن آنها به شدت متفاوت باشد به طور مشابه بلیط های ردیف جلو در یک کنسرت بسیار ارزشمند تر از بلیط خای ردیف عقب هستند.
...
در تعریف توکن های غیر قابل تعویض میتوان به دو سوال اصلی این توکن ها چه هستند و چگونه هستند رسید ؟ توکن های غیر قابل تعویض این اجازه را به ما میدهند که دارایی های غیر قابل تعویضمان را با استفاده از بستر بلاکچین بسیار راحت تر اثبات مالکیت بکنیم برای درک بهتر این توضیحات میتوان به مثال بلیط کنسرت اشاره کرد که منحصر به فرد برای هر صندلی و قابل اثبات برای هر شخص میباشند برای درک این موضوع باید به خواص اصلی این نوع دارایی ها بیشتر دقت کرد که عبارتند از :
 ...
 برای اینکه توکن های غیر قابل تعویض برای خریداران و سرمایه گذاران احتمالی جذاب باشند انها باید به طور قابل اثباتی کمیاب باشند. این تضمیین میکند که وضعیت بازار دارای در بلند مدت مطلوب باقی بماند و عرضه از تقاضای بازار پیش نگیرد.
 
 4. تقسیم ناپذیر بودن :
 
 ان اف تی  ها عمدتا نمیتوانند به عنوان کسری از خودشان معامله شوند درست مثل اینکه نمیتوان نیمی از یک بلیط کنسرت را خرید یا معامله کرد به طور خلاصه  توکن های غیر قابل تعویض را نمیتوان به ارزش های کوچک تر تقسیم کرد.
 ...
 اولین توکن های غیر قابل تعویض بر بستر بلاکچین احتمالا سکه های رنگی بیتکوین بوده اند. که برای اولین بار در یک پست وبلاگ توسط Yoni Assia در مارس 2012 فرموله شد. واحد های بسیار کوچکی از بیتکوین بودند که با ویژگی های خاص رنگ شده بودند و با استفاده از زبان اسکریپت بیتکیون به یک متادیتا ربط داده شده بودند که خود شروع مسیر NFT ها بود. به این ترتیب به دارایی های غیر قابل تعویض به ارزش یک ساتوشی (0.00000001 BTC) تبدیل شده بودند . اگر چه مفهوم سکه های رنگی بسیار امیدوار کننده و بالقوه بود اما آنها نیز نقص ها موانع عمده ای داشتند :
...
![alt text](https://github.com/rapexa/Introduction-to-NFTs/blob/main/Pictures/rarepepe.png)
 ...
 اگر چه گریپتو پانک ها در ابتدای راه خود برای عموم مردم احساس ویروسی داشتند اما اخیرا به دلیل اینکه آنها اولین NFT واقعی بودند که در بلاکچین اتریوم راه اندازی شدند بسیار مورد توجه قرار گرفته شدند ناگفته نماند از آنجایی که Cryptopunks قبل از ایجاد استاندارد توکن های غیر قابل تعویض ERC-721 ایجاد شده اند بنیان گذاران ان بعد ها مجبورد شدند از نسخه اصطاح شده ان استفاده کنند. با اینکه کریپتو پانک ها با استاندار توکن ERC-20 پیاده شده بودند اما انها به عنوان الهام بخش ایجاد استاندارد ERC-721 عمل کردند و راه را برای ایجاد این استاندارد هموار کردند.
 
 ![alt text](https://github.com/rapexa/Introduction-to-NFTs/blob/main/Pictures/cryptopunks.png)
 
 ## کریپتو کیتیز
 
 کریپتو کیتیز در اکتبر 2017 ساخته شد , یک بازی مجازی که اجازه میداد بازیکنان پرورش و بزرگ کردن و تجارت گربه های مجازی با ژنوم منحصر به فرد را بر بستر بلاکچین و با استفاده از NFT انجام دهند ژنوم منحصر به فردی که برای هر NFT وجود دارد باعث میشود که هر یک ظاهری منحصر به فرد داشته باشنداین یک ویژگی جدید بود این کالکشن بود که باعث شد از رقبای اون زمان خود پیشه بگیرد و مزیت رقابتی خاصی نسبت به انها داشته باشد این NFT در بحبوحه رونق ارز های دیجیتال در سال 2017 بود که معرفی شد و خیلی سریع شروع به افزایش تصاعدی قیمت کرد طوری که یک cyptokities در ان زمان به ارزش 600 اتریوم فروخته شد که در آن زمان حدود 172 هزار دلار امریکا میشد و مبلغ قابل توجهی برای یک NFT بود پروژه کریپتوکیتیز روند رشد عجیبی از نظر رسانه ای را نیز داشت طوری که حضور پر رنگی در همان سال ها در رسانه های اصلی امریکا از جمله CNN و CNBC و فایننشال تایمز پیدا کرد.امروزه فعالیت کریپتو کیتیز تا حدودیی کاهش یافته است و به همین ترتیب نسبت به ان زمان حجم معاملاتی  پایین تری دارد اما نمیتوانیم از تاثیری که کریپتوکیتیز بر دنیای NFT ها داشته چشم پوشی کنیم :)
